...
export default function ScreenPage() {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-black text-white flex flex-col items-center justify-between pt-10 pb-6 px-12">
      ...
      {/* QR Codes */}
      <div className={`relative z-10 flex items-end gap-16 -mt-6 transition-all duration-700 delay-400 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        {qrItems.map((item) => (
